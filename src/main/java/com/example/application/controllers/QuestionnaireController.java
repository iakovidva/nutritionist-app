...
public class QuestionnaireController {
    ...
    public String showQuestionnaire(Model model) {
        ...
        model.addAttribute("genderOptions", Demographic.Gender.values());
        model.addAttribute("weeklyFrequencyOptions", WeeklyFrequency.values());
        model.addAttribute("dietTypeOptions", DietaryPreferences.DietType.values());
        model.addAttribute("nutritionGoalsOptions", NutritionGoals.Goal.values());
